...
description: "The OpenAI Agents SDK backend uses OpenAI's agent framework with GPT models. Supports Ollama for local inference via OpenAI-compatible endpoints."
